...
class VUnet(nn.Module):
    def __init__(self, pretrained_path=None):
        ...
        self.bb = up_conv_block([512, 512, 512], [512, 512, 512], [3, 3, 3], [1, 1, 1], 512, 512, 2, 2)
        self.u1 = up_conv_block([1024, 512], [512, 512], [3, 3, 3], [1, 1, 1], 512, 256, 2, 2)
        self.u2 = up_conv_block([512, 256], [256, 256], [3, 3, 3], [1, 1, 1], 256, 128, 2, 2)
